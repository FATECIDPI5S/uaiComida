    ...
    chooseProfilePicture = () => {
        ImagePicker.showImagePicker(options, (response) => {
            ...
            if (response.didCancel) {
                ...
                this.setState({ foto: response.uri })
            }
        });
    }
        ...
        return (
            <View style={styles.container}>
                ...
                <Avatar
                    ...
                    rounded
                    showEditButton
                    overlayContainerStyle={{backgroundColor: '#c0392b'}}
                    icon={{name: 'user', type: 'font-awesome',color:'rgba(255, 255, 255, 0.8)'}}
                    source={{uri: this.state.foto}}
                    onEditPress={this.chooseProfilePicture}
                    editButton={{color: '#c0392b'}}
                    activeOpacity={0.7}
